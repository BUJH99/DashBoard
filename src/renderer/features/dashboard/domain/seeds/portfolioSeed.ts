...
export const portfolioData: PortfolioData = {
  ...
  coursework: [
    { id: 1, semester: "2023-1", name: "디지털 논리회로", grade: "A+", relevance: 100, tags: ["Boolean Algebra", "K-Map", "FSM"] },
    { id: 2, semester: "2023-2", name: "컴퓨터 구조", grade: "A0", relevance: 95, tags: ["Pipeline", "Cache", "RISC-V"] },
    { id: 3, semester: "2024-1", name: "SoC 설계 및 실습", grade: "A+", relevance: 90, tags: ["Verilog", "AMBA AXI", "FPGA"] },
    { id: 4, semester: "2024-1", name: "반도체 공학", grade: "B+", relevance: 70, tags: ["CMOS", "MOSFET", "Fabrication"] },
    { id: 5, semester: "2024-2", name: "운영체제", grade: "B0", relevance: 60, tags: ["Process", "Memory Management"] },
  ],
  studyProjects: [
    {
      id: 1,
  ...
  projects: [
    {
      ...
      browserLink: "https://example.com/riscv-pipeline",
      documentLink: "",
    },
    {
      id: 2,
      ...
      browserLink: "https://example.com/axi4-controller",
      documentLink: "",
    },
    {
      id: 3,
      ...
      browserLink: "https://example.com/cnn-mac",
      documentLink: "",
    },
  ],
  experienceHub: [
